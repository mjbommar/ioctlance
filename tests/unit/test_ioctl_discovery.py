...
def test_ioctl_discovery_rtdashpt(rtdashpt_path):
    ...
    expected_ioctls = {"0x12c800", "0x12c804", "0x12c80c", "0x12c810", "0x12c814", "0x12c8c0", "0x12c8c4"}
    ...
    handler, handler_state = find_ioctl_handler(rtdashpt_path, timeout=30, global_var_size=0, complete_mode=False)
