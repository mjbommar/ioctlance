...
class BatchConfig(BaseModel):
    ...
    filter_false_positives: bool = Field(default=True, description="Filter detected false positives")
    reclassify_vulnerabilities: bool = Field(default=True, description="Reclassify misidentified vulnerabilities")
