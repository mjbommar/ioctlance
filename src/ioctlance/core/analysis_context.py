...
class AnalysisConfig(BaseModel):
    ...
    filter_false_positives: bool = True  # Automatically filter detected false positives
    reclassify_vulnerabilities: bool = True  # Allow reclassification of misidentified vulns

    @field_validator("verification_level")
    @classmethod
    def validate_verification_level(cls, v: str) -> str:
        valid_levels = ["none", "basic", "standard", "deep"]
...
class AnalysisContext:
    ...
    def add_vulnerability(self, vuln_info: dict[str, Any]) -> None:
        ...
        """
        # Run post-detection verification if enabled
