...
class BatchVerifier:
    ...
    def print_report(self):
        ...
        print(f"False Positives: {self.stats['false_positives']} ({self.stats['false_positives']*100/self.stats['total']:.1f}%)")
        print(f"Reclassified: {self.stats['reclassified']} ({self.stats['reclassified']*100/self.stats['total']:.1f}%)")
